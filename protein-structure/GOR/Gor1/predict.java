...
// and a Fasta File with aa sequence
    ...
    public static void entryFromRunner(String filePathFasta, String filePathModel, String format) {
        printPredictionAsSeclib(filePathFasta, filePathModel, format);
    }

    //private HashMap<String, HashMap<Character, int[]>> ssMatrices;

    public static HashMap<String, HashMap<Character, int[]>> readModelFile(String filePath) {
    ...
    public static HashMap<String, String> readFastaFile(String filePathFasta) { //store header and seq in hashmap
    ...
    public static HashMap<String, Double> stateFrequenciesInfoDif(HashMap<String, HashMap<Character, int[]>> countMatrices) {
    ...
    private static double calculateInfoDiff(int[] counts, String State, HashMap<String, HashMap<Character, int[]>> CountMatrices) { //parameter: array with counts for each position in window
        double sum = 0.0;
    ...
    public static String predictSecondaryStructure(String sequence, HashMap<String, HashMap<Character, int[]>> CountMatrices) { //gets aa sequence and returns predicted ss sequence
        int windowSize = 17;
    ...
    private static String predictStructurePos(String window, HashMap<String, HashMap<Character, int[]>> CountMatrices) { //gets passed windows of seq from predictSecondaryStructure
    ...
    public static void printPredictionAsSeclib(String filePathFasta, String filePathModel, String format) {
        if (format == "txt") {
            ...
            System.out.println("html not yet supported");
        }
    }
    ...
    /*
    public static void FormatOption(String filePathFasta, String filePathModel) {
        HashMap<String, HashMap<Character, int[]>> CountMatrices = new HashMap<>();
        CountMatrices = readModelFile(filePathModel);
