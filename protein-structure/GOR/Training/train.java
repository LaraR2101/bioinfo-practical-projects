...
public class train {
    ...
    char[] noAAs = {'B','J','O','U','X','Z'};

    HashMap<Character, int[]> SheetAminoMatrix = new HashMap<Character, int[]>();
    HashMap<Character, int[]> CoilAminoMatrix = new HashMap<Character, int[]>();
    HashMap<Character, int[]> HelixAminoMatrix = new HashMap<Character, int[]>();

    HashMap<String, HashMap<Character, int[]> > ssMatrices = new HashMap<>();
    ...
    public void countOccurences(String Aminosequence, String SecStrucSequence) {
    ...
    public void CountWindowSS(String cur_ss, String window) {
    ...
    public void printMatrix(Character c, HashMap<Character, int[]> AminoMatrix){
    ...
    public void printMatrixToTxt(HashMap<String, HashMap<Character, int[]> > maps, String outputpath) {
        try {
    ...
    public int getMatrixSum(HashMap<Character, int[]> AminoMatrix){
        int sum = 0;
        for(Character key : AminoMatrix.keySet()){
            int[] values = AminoMatrix.get(key);
            for(int value : values){
    ...
    public HashMap<String, HashMap<Character, int[]>> getSsMatrices() {
        return ssMatrices;
    }
